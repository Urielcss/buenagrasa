...
import ResponseModal from "./respondemodal";
...
export default function ContactPage() {
  ...
  return (
    <section className="min-h-screen pt-24 px-4 pb-16 flex items-center relative">
      <ResponseModal
        isOpen={isModalOpen}
                ...
                className={`w-full px-8 py-4 font-bold rounded-lg transition-all shadow-lg shadow-yellow-500/50 
                                    ${
                                      status === "sending"
                                        ...
                                        : "bg-linear-to-r from-yellow-400 to-yellow-600 text-black hover:scale-105"
                                    }
                                `}
              >
